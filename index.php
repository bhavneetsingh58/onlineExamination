...
<title>VidhyaShal Academy </title>
...
<div class="row">
<div class="col-lg-6">
<span class="logo">VidhyaShala Academy</span></div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="col-md-4">
		 ...
		 <div class="col-md-5">
		<a href="bhavneeetsingh.com" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">Bhavneet Singh</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1"></h4>
		<h4 style="font-family:'typo' ">bhavneetsachdev58@gmail.com</h4>
		<h4 style="font-family:'typo' ">____</h4></div></div>
		</p>
      </div>
